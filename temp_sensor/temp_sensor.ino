...
void  setup()
{
  Serial.begin(9600);                            //  It tells the Arduino that the display is a 16x2 type
  Serial.print("Temperature: ");           //  Send the text to the screen of the display.
}
void  loop()
{
  ...
  //Serial.setCursor(0, 1);           // Moves  the cursor of the display to the next line
  Serial.print(TF);    // Exhibits the value of the temperature on the display
  Serial.print(" F");         // Writes “F” to indicate that it is in Fahrenheit scale.
  Serial.print('\n');
